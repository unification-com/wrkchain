...
def build_host_vars(build_root: Path, t_root: Path, validators: Validators):
    ...
    for context in validators.context:
...
def generate_ansible(build_dir, config, configured_bootnode_cfg):
    ...
    build_host_vars(build_root, templates, validator_builder)
