...
Set `WRKCHAIN_ROOT_CONTRACT_ADDRESS` to the Contract address obtained in section 3.2  
Set `WRKCHAIN_WEB3_PROVIDER_URL` to the appropriate Web3 Provider URL for the WRKChain
